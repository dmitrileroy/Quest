...
import useFrame1 from 'src/components/Frame1/useFrame1';
...
function Frame1(props: Frame1Props): JSX.Element {
  ...
  return (
    <Frame11 className={props.className} >
      ...
      <Rectangle1 onClick={fns.onClick} data={data}  aria-label={"100"}  aria-describedby={"202"} >
      </Rectangle1>
      <HelloWorld >
        {`Hello World`}
          </HelloWorld>
      <Frame3 id={"500"}  props={props}  aria-label={"helo"} >
        <Popover  
          marginThreshold={0}
      ...
      {(true) &&
        <Tooltip null arrow={true} placement={"top"} componentsProps={{ tooltip: { sx: { maxWidth: "200px", }, } }} title={hello}>
