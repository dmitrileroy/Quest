  ...
  return (
    <Export1 >
       ...
       <ExportContent >
         ...
         <ButtonContained variant="contained" size="small" color="primary"  onClick={() => fns.exportFn(props.setAnchorEl)}  > Download </ButtonContained>
       </ExportContent>
